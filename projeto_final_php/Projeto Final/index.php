...
<head>
  ...
  <body>
      <div class="container">
        <h1 class="jumbotron bg-info">Seja bem vindo ao sistema</h1>
        ...
        <h1>Sistema para gerênciamento do mercado</h1>
        ...
        if(isset($_SESSION['privateUser'])){
          ...
          $u = unserialize($_SESSION['privateUser']);
          if ($u->tipo=="administrativo") {
          echo "<h2>Olá {$u->login}, cadastre aqui novos usuários</h2>";
        ...
        <form name="cadusuraio" method="post" action="">
          <div class="form-group">
            <input type="text" name="txtlogin" placeholder="Login do usuário" class="form-control">
          </div>
          <div class="form-group">
            <input type="password" name="txtsenha" placeholder="Senha do usuario" class="form-control">
          </div>
          <div class="form-group">
        ...
        if(isset($_POST['Cadastrar'])){
          ...
          $u = new Usuario();
          $u->login = Padronizacao::antiXSS($_POST['txtlogin']);
          $u->senha = Padronizacao::antiXSS(Seguranca::criptografar($_POST['txtsenha']));
          $u->tipo = Padronizacao::antiXSS($_POST['seltipo']);

          $uDAO = new UsuarioDAO();
          $usuario = $uDAO->cadastrarUsuario($u);

          $_SESSION['msg'] = "Usuário cadastrado com sucesso!";
          header("location:index.php");

          if($usuario == null){
            echo "<h2>Usuário, senha e/ou tipo inválido(s)!</h2>";
          }else{
            // echo "<h2>logado</h2>";
